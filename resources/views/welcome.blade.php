...
<body class="font-sans text-slate-800 bg-white flex flex-col min-h-screen">
    ...
    <main class="flex-grow pt-16">
        ...
        {{-- PREVIEW LOWONGAN UNGGULAN --}}
        <section class="py-20 bg-slate-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-10">
                    <div>
                        <span class="text-sm font-bold text-cesco-orange tracking-widest uppercase">Kesempatan
                            Terbaru</span>
                        <h2 class="text-3xl font-display font-bold text-cesco-blue mt-1">Peluang Karir Unggulan</h2>
                    </div>
                    <a href="{{ route('career') }}"
                        class="mt-4 md:mt-0 text-cesco-blue hover:text-cesco-orange font-bold flex items-center gap-2 transition-colors">
                        Lihat Semua Lowongan <i class="bi bi-arrow-right-circle-fill"></i>
                    </a>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {{-- Kartu 1 --}}
                    <div
                        class="bg-white border border-slate-100 rounded-xl p-6 flex flex-col justify-between hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                        <div>
                            <div class="flex justify-between items-start mb-4">
                                <span
                                    class="px-3 py-1 text-xs font-semibold rounded-full bg-blue-50 text-cesco-blue">Engineering</span>
                                <span class="text-xs text-slate-400"><i
                                        class="bi bi-geo-alt-fill mr-1 text-cesco-orange"></i>Batam</span>
                            </div>
                            <h4 class="text-lg font-bold text-slate-800 mb-2">Proposal Engineer</h4>
                            <p class="text-sm text-slate-500 mb-6 line-clamp-3">
                                Mengestimasi biaya proyek komersial dan menyusun strategi kontrak pra-komisi lingkungan
                                EPC / Minyak & Gas.
                            </p>
                        </div>
                        <div class="border-t border-slate-100 pt-4 flex justify-between items-center">
                            <span class="text-xs text-slate-400">Penuh Waktu</span>
                            <a href="{{ route('career') }}"
                                class="text-cesco-orange hover:text-orange-600 font-bold text-sm">
                                Detail Karir <i class="bi bi-chevron-right"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <div class="flex justify-between items-start mb-4">
                                <span
                                    class="px-3 py-1 text-xs font-semibold rounded-full bg-orange-50 text-cesco-orange">Quality
                                    & HSE</span>
                                <span class="text-xs text-slate-400"><i
                                        class="bi bi-geo-alt-fill mr-1 text-cesco-orange"></i>Batam</span>
                            </div>
                            <h4 class="text-lg font-bold text-slate-800 mb-2">Pre-Commissioning Inspector</h4>
                            <p class="text-sm text-slate-500 mb-6 line-clamp-3">
                                Inspeksi kelayakan teknikal struktur rekayasa dan memandu aktivitas chemical cleaning
                                untuk industri petrokimia.
                            </p>
                        </div>
                        <div class="border-t border-slate-100 pt-4 flex justify-between items-center">
                            <span class="text-xs text-slate-400">Kontrak Proyek</span>
                            <a href="{{ route('career') }}"
                                class="text-cesco-orange hover:text-orange-600 font-bold text-sm">
                                Detail Karir <i class="bi bi-chevron-right"></i>
                            </a>
                    ...
                    <div
                        ...
                        <div>
                            <div class="flex justify-between items-start mb-4">
                                <span
                                    class="px-3 py-1 text-xs font-semibold rounded-full bg-green-50 text-emerald-700">Project
                                    Mgmt</span>
                                <span class="text-xs text-slate-400"><i
                                        class="bi bi-geo-alt-fill mr-1 text-cesco-orange"></i>Batam</span>
                            </div>
                            <h4 class="text-lg font-bold text-slate-800 mb-2">Project Manager</h4>
                            <p class="text-sm text-slate-500 mb-6 line-clamp-3">
                                Memimpin manajemen proyek fabrikasi mulai dari fase rekayasa awal, alokasi budgeting,
                                hingga target waktu komisi ke site.
                            </p>
                        </div>
                        <div class="border-t border-slate-100 pt-4 flex justify-between items-center">
                            <span class="text-xs text-slate-400">Penuh Waktu</span>
